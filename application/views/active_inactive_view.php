...
<?php echo form_open('ActiveInactive');?>

<!-- Page Content -->
<div class="container">
    <h3 class="my-4">Chart Active-Inactive</h3>
    <div class="row" >
...
Highcharts.chart('columncharts', {
    ...
    foreach($dataRS as $dr){
        echo "{name: '".$dr['hostname']."',color:'".$dr['color']."',data: [".$dr['ActiveInactive']."]},";
        $i++;
    }//for
    ?>
    ]
